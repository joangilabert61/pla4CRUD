package pla4CRUD;
	...
	public class Ventas implements GestioTaula{
		...
		String nom_taula="ventas";
		String clau_principal="ven_id";
		...
		//----------------------------------------------------------------------- Constructor
		//
			public Ventas(AccesoADatos wGestioBBDD) 
			{
		...
		public void esborrar_registre(){
			...
			Scanner valor_entrat = new Scanner(System.in);
			System.out.println("Introdueix el id de venda :");
		...
		public void modificar_registre(){
			...
			Scanner valor_entrat = new Scanner(System.in);
			System.out.println("Introdueix el id de la venda :");
