package pla4CRUD;
	...
	public class Productos implements GestioTaula{
		...
		String nom_taula="productos";
		String clau_principal="art_cod";
		...
		//----------------------------------------------------------------------- Constructor
		//
			public Productos(AccesoADatos wGestioBBDD) 
			{
	 ...
	 //         System.out.println("Columnas: "+col);
		...
		public void modificar_registre(){
			...
			Scanner valor_entrat = new Scanner(System.in);
			System.out.println("Introdueix el codi de producte a modificar :");
