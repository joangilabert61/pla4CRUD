...
public class Clientes implements GestioTaula{
	...
	String nom_taula="clientes";
	String clau_principal="cli_id";
	...
	//----------------------------------------------------------------------- Constructor
	//
		public Clientes(AccesoADatos wGestioBBDD) 
		{
	...
	public void esborrar_registre(){
		...
		Scanner valor_entrat = new Scanner(System.in);
		System.out.println("Introdueix el codi de client (CNI/CIF) :");
		String wValorEntrat = valor_entrat.nextLine();
	...
	public void modificar_registre(){
		...
		Scanner valor_entrat = new Scanner(System.in);
		System.out.println("Introdueix el codi de client a modificar (CNI/CIF) :");
